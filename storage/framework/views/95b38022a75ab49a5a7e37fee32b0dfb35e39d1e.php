    ...
    <section class="container mt-45">
        ...
        <form action="/payments/payment-request" method="post" class=" mt-25">
            ...
            <div class="row">
                <?php if(!empty($paymentChannels)): ?>
                    <?php $__currentLoopData = $paymentChannels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentChannel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-6 col-lg-4 mb-40 charge-account-radio">
                            <input type="radio" name="gateway" id="<?php echo e($paymentChannel->title); ?>" data-class="<?php echo e($paymentChannel->class_name); ?>" value="<?php echo e($paymentChannel->id); ?>" class="payment-channel">
                ...
                <div class="col-6 col-lg-4 mb-40 charge-account-radio">
                    <input type="radio" <?php if(empty($userCharge) or ($total > $userCharge)): ?> disabled <?php endif; ?> name="gateway" id="offline" value="credit" class="payment-channel">
            ...
            <div class="d-flex align-items-center justify-content-between mt-45">
                <label for="oneTimePayment" class="font-16 font-weight-500 text-gray mr-3" style="display: inline-block;">Total Amount <?php echo e(addCurrencyToPrice($total)); ?></label>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/app/resources/views/web/default/cart/payment.blade.php ENDPATH**/ ?>